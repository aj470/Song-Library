/* Name: Gabriel Gutierrez, Lyle Filonuk
 * RUID: gg548, filonukl
 */
package view;
...
public class SongLibController
{
    ...
    public void click(ActionEvent e) throws IOException
    {
        ...
        else //x == edit
        {
            ...
            if (songList.getSelectionModel().getSelectedItem() != null)
            {
                if(!n.equals(songList.getSelectionModel().getSelectedItem().getName()) || !a.equals(songList.getSelectionModel().getSelectedItem().getArtist()))
                {
                    if (backend.exists(n, a, obsList))
                    {
                        header = "Edit Failed!";
    ...
    {
        sName.setText(songList.getSelectionModel().getSelectedItem().getName().trim());
        sArtist.setText(songList.getSelectionModel().getSelectedItem().getArtist().trim());
        sAlbum.setText(songList.getSelectionModel().getSelectedItem().getAlbum().trim());
        sYear.setText(songList.getSelectionModel().getSelectedItem().getYear().trim());
